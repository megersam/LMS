...
import { addAnswer, addQuestion, addReplyData, addReview, editCourse, getAllCourses, getCoursesByUser, getSingleCourse, uploadCourse } from "../Controllers/course.Controller";
